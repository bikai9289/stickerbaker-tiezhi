defmodule StickerWeb.CoreComponents do
  @moduledoc """
  ...
  def input(assigns) do
    ...
    <div class="w-full" phx-feedback-for={@name}>
      ...
      <input
        ...
        class={[
          "mt-2 block w-full rounded-lg border-zinc-300 py-2.5 sm:py-3 px-3",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(StickerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(StickerWeb.Gettext, "errors", msg, opts)
    end
  end
