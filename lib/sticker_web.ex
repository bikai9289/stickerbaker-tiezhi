defmodule StickerWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: StickerWeb.Layouts]
  ...
  defp html_helpers do
    quote do
      ...
      import StickerWeb.CoreComponents
      import StickerWeb.Gettext
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        endpoint: StickerWeb.Endpoint,
        router: StickerWeb.Router,
        statics: StickerWeb.static_paths()
    end
  end
